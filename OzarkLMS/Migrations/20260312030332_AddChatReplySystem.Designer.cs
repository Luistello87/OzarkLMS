...
namespace OzarkLMS.Migrations
{
    ...
    [Migration("20260312030332_AddChatReplySystem")]
    partial class AddChatReplySystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OzarkLMS.Models.ChatMessage", b =>
                {
                    ...
                    b.HasOne("OzarkLMS.Models.ChatMessage", "ParentMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("OzarkLMS.Models.PrivateMessage", b =>
                {
                    b.HasOne("OzarkLMS.Models.PrivateMessage", "ParentMessage")
                        .WithMany()
                        .HasForeignKey("ParentMessageId")
                        .OnDelete(DeleteBehavior.SetNull);
